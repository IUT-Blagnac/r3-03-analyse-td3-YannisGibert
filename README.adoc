...
Le but de ce TD/TPppppppppppppppppppppppppp est de vous montrer des exemples de traces formelles entre les différents artefacts de votre application (des exigences jusqu'au code).
